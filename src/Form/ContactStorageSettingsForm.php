...
class ContactStorageSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['send_html'] = array(
      '#type' => 'checkbox',
      '#title' => t('Send HTML'),
      '#description' => t('Whether the mails should be sent as HTML. A module like <a href=\'https://www.drupal.org/project/swiftmailer\'>Swiftmailer</a> is needed for this feature.'),
