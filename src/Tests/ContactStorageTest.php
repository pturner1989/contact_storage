...
class ContactStorageTest extends ContactStorageTestBase {
  ...
  public function testAutoReplyField() {
    ...
    $this->assertTrue($this->xpath('//textarea[@id="edit-reply-value" and text()="auto_reply_1"]'));
    ...
    $this->assertTrue(strpos(end($captured_emails)['body'], 'auto_reply_1') !== FALSE);
    ...
    // properly set.
    $this->drupalPostForm(NULL, ['reply[format]' => 'full_html'], t('Save'));
    $this->drupalGet('admin/structure/contact/manage/test_auto_reply_id_1');
